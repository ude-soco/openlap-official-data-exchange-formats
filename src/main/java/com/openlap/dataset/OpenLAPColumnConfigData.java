...
public class OpenLAPColumnConfigData {
   ...
   */
  public OpenLAPColumnConfigData(
      String id, OpenLAPColumnDataType type, boolean required, String title, String description) {
    this.setId(id);
    this.type = type;
  ...
  /**
   * Validate the correspondence of the type of another OpenLAPColumnConfigData
   *
   * @param outputPortConfigData OpenLAPColumnConfigData to be compared with this
   *     OpenLAPColumnConfigData
   * @return true if the type is the same and the other OpenLAPColumnConfigData id is not empty or
   *     null
   */
