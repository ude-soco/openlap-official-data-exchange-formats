...
/**
 * Mapping between OpenLAPColumnConfigData. It uses an array of OpenLAPPortMappings that represents
 * all the Output and Input Ports. Is important to note that "OutputPort" denotes a column
 * configuration of the SOURCE macro component, whereas the "InputPort" denotes the column
 * configuration of the RECEIVING macro component. It is name so because the SENDING macro component
 * "outputs" data to the RECEIVING macro component "inputs".
 */
public class OpenLAPPortConfig {
   ...
   *
   * @return An Array of OpenLAPColumnConfigData that corresponds to all the outputs of the
   *     OpenLAPPortConfig
   */
  @JsonIgnore
   ...
   *
   * @return An Array of OpenLAPColumnConfigData that corresponds to all the inputs of the
   *     OpenLAPPortConfig
   */
  @JsonIgnore
   ...
   *
   * @param side OpenLAPConfigDataSides.OUTPUTDATA or OpenLAPConfigDataSides.INPUTDATA to define
   *     which side to get
   * @return OpenLAPPortMapping array with either the output configurations or the input
   *     configurations
   */
  ...
  public String toString() {
    ...
    try {
      ...
      return "OpenLAPPortConfig{" + "mapping=" + mapping + '}';
    }
  }
