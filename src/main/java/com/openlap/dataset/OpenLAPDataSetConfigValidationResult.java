...
/**
 * This object encapsulates the validation operation of a configuration of an OpenLAPDataSet. It
 * contains two main fields: One describing the validation result as a boolean, another with
 * additional information of the validation process, most useful when the validation does not pass,
 * since describes which fields and reasons caused the validation to fail.
 */
