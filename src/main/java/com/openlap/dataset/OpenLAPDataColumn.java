 ...
 * OpenLAPColumnConfigData describes. In conjunction, it is denominated a OpenLAPDataColumn.
 */
public class OpenLAPDataColumn<T> {
  ...
  /**
   * Constructor that sets the OpenLAPColumnConfigData with the ID, type, required, title and
  ...
  public boolean validateConfigurationData(OpenLAPColumnConfigData openLAPColumnConfigData) {
    return this.getConfigurationData()
        .validateConfigurationDataCorrespondence(openLAPColumnConfigData);
  }
